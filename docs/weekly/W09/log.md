...
- **2025-03-06** — W09-T04: Utworzono dokument architektury kodu `docs/architecture/orderflow-code-baseline.md`: lista projektów (API, worker, testy), odpowiedzialność, struktura katalogów, konwencje (health, logging, CI). Prosty, pragmatyczny opis bez overengineeringu.
